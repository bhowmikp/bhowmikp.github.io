  ...
  return function e(t, r, n) {
    function a(u, s) {
      ...
      var n = e("github-calendar-parser"),
          ...
          u = e("formatoid");t.exports = function (e, t, r) {
        e = a(e), (r = r || {}).summary_text = r.summary_text || 'Summary of pull requests, issues opened, and commits made by <a href="https://github.com/' + t + '" target="blank">@' + t + "</a>", !1 === r.global_stats && (e.style.minHeight = "175px"), r.proxy = r.proxy || function (e) {
          return "https://urlreq.appspot.com/req?method=GET&url=" + e;
        };return function s() {
          return fetch(r.proxy("https://github.com/" + t)).then(function (e) {
            return e.text();
          }).then(function (t) {
            var i = document.createElement("div");i.innerHTML = t;var c = i.querySelector(".js-contribution-graph");if (c.querySelector(".float-left.text-gray").innerHTML = r.summary_text, c.querySelector("include-fragment")) setTimeout(s, 500);else {
              if (!0 === r.responsive) {
                var l = c.querySelector("svg.js-calendar-graph-svg"),
                    d = l.getAttribute("width"),
                    f = l.getAttribute("height");l.removeAttribute("height"), l.setAttribute("width", "100%"), l.setAttribute("viewBox", "0 0 " + d + " " + f);
              }if (!1 !== r.global_stats) {
                var p = n(a("svg", c).outerHTML),
                    ...
                    g = a("<div>", { class: "contrib-column contrib-column-first table-column", html: '<span class="text-muted">Contributions in the last year</span>\n                               <span class="contrib-number">' + p.last_year + ' total</span>\n                               <span class="text-muted">' + u(o.subtract(new Date(), 1, "year"), "MMM D, YYYY") + " – " + u(new Date(), "MMM D, YYYY") + "</span>" }),
                    h = a("<div>", { class: "contrib-column table-column", html: '<span class="text-muted">Longest streak</span>\n                               <span class="contrib-number">' + p.longest_streak + ' days</span>\n                               <span class="text-muted">' + m + "</span>" }),
                    y = a("<div>", { class: "contrib-column table-column", html: '<span class="text-muted">Current streak</span>\n                               <span class="contrib-number">' + p.current_streak + ' days</span>\n                               <span class="text-muted">' + b + "</span>" });c.appendChild(g), c.appendChild(h), c.appendChild(y);
      ...
      function n(e) {
        return function t(r, n, a) {
          switch (n *= e, a) {case "years":case "year":
      ...
      var n = e("months"),
          ...
          var t = -e.getTimezoneOffset();return (t >= 0 ? "+" : "-") + o(parseInt(t / 60)) + ":" + o(t % 60);
        }, ZZ: function ZZ(e) {
          var t = -e.getTimezoneOffset();return (t >= 0 ? "+" : "-") + o(parseInt(t / 60)) + o(t % 60);
        } },
          s = new (0, e("parse-it").Parser)(u);t.exports = function (e, t) {
        return s.run(t, [e, e._useUTC]);
      };
    }, { days: 3, fillo: 5, months: 10, "parse-it": 11 }], 7: [function (e, t, r) {
      t.exports = ["#eee", "#d6e685", "#8cc665", "#44a340", "#1e6823"];
    }, {}], 8: [function (e, t, r) {
      var n = e("github-calendar-legend");t.exports = function (e) {
        var t = { last_year: 0, longest_streak: -1, longest_streak_range: [], current_streak: 0, current_streak_range: [], weeks: [], days: [], last_contributed: null },
          ...
          if (e.startsWith("<g transform")) return r.length && t.weeks.push(r) && (r = []);var o = e.match(/fill="(#[a-z0-9]+)"/),
              u = e.match(/data-date="([0-9\-]+)"/),
              s = e.match(/data-count="([0-9]+)"/);if (o = o && o[1], u = u && u[1], s = s && +s[1], o) {
            var i = { fill: o, date: new Date(u), count: s, level: n.indexOf(o) };0 === t.current_streak && (t.current_streak_range[0] = i.date), i.count ? (++t.current_streak, t.last_year += i.count, t.last_contributed = i.date, t.current_streak_range[1] = i.date) : (a(), t.current_streak = 0), r.push(i), t.days.push(i);
          }
        }), a(), t;
      };
