    ...
    <AppLayout title="CSCA48s17">
        <div className="mx-5 mb-10">
            ...
            <ul className="tutorial-default-spacing tutorial-list-style">
                <li>
                    <CustomLinkLocal link="/csca48s17/insertion_sort_w12.txt" label="Insertion Sort" />
                </li>
            </ul>
            ...
            <ul className="tutorial-default-spacing tutorial-list-style">
                <li>
                    Recursion: <CustomLinkLocal link="/csca48s17/binary_search_w11.txt" label="Binary Search example" />
                </li>
            </ul>
            ...
            <ul className="tutorial-default-spacing tutorial-list-style">
                <li>
                    Recursion: <CustomLinkLocal link="/csca48s17/same_string_w10.txt" label="Same string example" />
                </li>
            </ul>
            ...
            <ul className="tutorial-default-spacing tutorial-list-style">
                <li>
                    Recursion: <CustomLinkLocal link="/csca48s17/fib_w9.txt" label="Fibonacci example" />
                </li>
            </ul>
            ...
            <ul className="tutorial-default-spacing tutorial-list-style">
                <li>
                    ...
                    <CustomLinkLocal link="/csca48s17/heap_w8.txt" label="remove_max function" />
                </li>
                <li>
            ...
            <ul className="tutorial-default-spacing tutorial-list-style">
                <li>
                    <CustomLinkLocal link="/csca48s17/deletion_bst_w7.txt" label="Deletion in Binary Search Tree" />
                </li>
            </ul>
            ...
            <ul className="tutorial-default-spacing tutorial-list-style">
                <li>
                    <CustomLinkLocal link="/csca48s17/dll_w5.txt" label="Doubly Linked List" />
                </li>
            </ul>
            ...
            <ul className="tutorial-default-spacing tutorial-list-style">
                <li>
                    <CustomLinkLocal link="/csca48s17/deque_w4.txt" label="Deque ADT" />
                </li>
                <li className="mb-3">
                    <CustomLinkLocal link="/csca48s17/deque_dict_w4.txt" label="Deque Dict ADT" />
                </li>

                <li>
                    <CustomLinkLocal link="/csca48s17/is_palindrome_w4.txt" label="Use of Deque" />
                </li>
                <li>
                    <CustomLinkLocal
                        link="/csca48s17/representation_invariant_maker_w4.txt"
            ...
            <ul className="tutorial-default-spacing tutorial-list-style">
                <li>
                    <CustomLinkLocal link="/csca48s17/queue_w3.txt" label="Queue ADT" />
                </li>
                <li>
                    <CustomLinkLocal link="/csca48s17/stack_w3.txt" label="Stack ADT" />
                </li>
                <li>
                    <CustomLinkLocal link="/csca48s17/binary_w3.txt" label="Decimal to Binary" />
                </li>
            </ul>
            ...
            <ul className="tutorial-default-spacing tutorial-list-style">
                <li>
                    <CustomLinkLocal link="/csca48s17/memory_model_w2.txt" label="Memory Model" />
                </li>
                <li>
                    <CustomLinkLocal link="http://pythontutor.com/" label="Python Tutor" /> is a good resource to use to
                    visualize the memory model. Choose "render all objects", "use text labels for references", and
