    ...
    <AppLayout title="CSCA48w18">
        <div className="mx-5 mb-10">
            ...
            <ul className="tutorial-default-spacing tutorial-list-style">
                ...
                <ul className="tutorial-default-spacing tutorial-list-style">
                    <li>
                        <CustomLinkLocal link="/csca48w18/same_string_w11.txt" label="Same string" />
                    </li>
                </ul>
            </ul>
            ...
            <ul className="tutorial-default-spacing tutorial-list-style">
                ...
                <ul className="tutorial-default-spacing tutorial-list-style">
                    <li>
                        <CustomLinkLocal link="/csca48w18/htree_w9.txt" label="HTree" />
                    </li>
                    <li>
                        <CustomLinkLocal link="/csca48w18/graphics_w9.txt" label="Graphics.py" />
                    </li>
                </ul>
            </ul>
            ...
            <ul className="tutorial-default-spacing tutorial-list-style">
                ...
                <ul className="tutorial-default-spacing tutorial-list-style">
                    <li>
                        <CustomLinkLocal link="/csca48w18/vowel_count_w8.txt" label="Vowel Count" />
                    </li>
                </ul>
            </ul>
            ...
            <ul className="tutorial-default-spacing tutorial-list-style">
                <li>
                    Heap:
                    <CustomLinkLocal
                        link="/csca48w18/heap_w7.txt"
                        label="Example 1"
                        labelGtm="heap example 1"
                        className="mx-2"
                    />
                    <CustomLinkLocal link="/csca48w18/more_heap_w7.txt" label="Example 2" labelGtm="heap example 2" />
                </li>
            </ul>
            ...
            <ul className="tutorial-default-spacing tutorial-list-style">
                <li>
                    <CustomLinkLocal link="/csca48w18/DLL_Node_List_w5.txt" label="DLL Node and List" />
                </li>
                <li>
                    <CustomLinkLocal link="/csca48w18/index_dll_w5.txt" label="DLL insert and remove methods" />
                </li>
            </ul>
            ...
            <ul className="tutorial-default-spacing tutorial-list-style">
                <li>
                    <CustomLinkLocal link="/csca48w18/dequeue_w4.txt" label="Dequeue ADT" />
                </li>
            </ul>
            ...
            <ul className="tutorial-default-spacing tutorial-list-style">
                <li>
                    How to make{' '}
                    <CustomLinkLocal
                        link="/csca48w18/representation_invariant_maker_w3.txt"
                        label="representation invariant"
                    />
                </li>

                <li>
                    <CustomLinkLocal link="/csca48w18/stack_w3.txt" label="Stack ADT" />
                </li>
                <li>
                    <CustomLinkLocal link="/csca48w18/decimal_to_binary_w3.txt" label="Decimal to Binary" />
                </li>
            </ul>
            ...
            <ul className="tutorial-default-spacing tutorial-list-style">
                <li>
                    <CustomLinkLocal link="/csca48w18/vector_w2.txt" label="Vector ADT" />
                </li>
            </ul>
        </div>
    </AppLayout>
