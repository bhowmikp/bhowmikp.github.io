...
const Csca48w18: FC & { getLayout: ReactNode } = () => (
    <div className="mx-auto w-10/12 md:w-9/12 lg:px-14 my-20">
        ...
        <p className="tutorial-default-spacing">
            ...
            question on <CustomLinkLocal link="https://piazza.com/mail.utoronto.ca/winter2018/csca48" label="Piazza" />{' '}
        ...
        <ul className="tutorial-default-spacing tutorial-list-style">
            <li>
                ...
                <CustomLinkLocal
                    ...
                    className="mx-2"
                />
                <CustomLinkLocal link="/ta/csca48w18/more_heap_w7.txt" label="Example 2" labelGtm="heap example 2" />
            </li>
        </ul>
        ...
        <ul className="tutorial-default-spacing tutorial-list-style">
            ...
            <ul className="tutorial-default-spacing tutorial-list-style">
                <li>
                    Difference between TNode(points to child only) and BTNode(points to child and child points back to
                    parent)
                </li>
...
Csca48w18.getLayout = (page: ReactElement) => (
    <>
        <NextSeo
            title="CSCA48w18"
            description="Material I taught in my tutorial for Introduction to Computer Science II (CSCA48) during Winter semester of 2018"
        />
